...
// ─── intellterm.wta/session_hook + sessions/changed ─────────────────────────
...
/// ExtNotification method for "master-side session registry changed; refetch if needed".
